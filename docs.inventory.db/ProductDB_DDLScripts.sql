...
CREATE  TABLE IF NOT EXISTS `PRODUCTDB`.`PRODUCT_VARIATION` (
  ...
  `VARIATION_VALUE` VARCHAR(45) NULL ,
...
-- -----------------------------------------------------
-- Table `PRODUCTDB`.`VARIATIONS_VALUE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PRODUCTDB`.`VARIATIONS_VALUE` ;

CREATE  TABLE IF NOT EXISTS `PRODUCTDB`.`VARIATIONS_VALUE` (
...
CREATE  TABLE IF NOT EXISTS `PRODUCTDB`.`ACCOUNT_SUBSCRIPTION` (
  ...
  CONSTRAINT `fk_ACCOUNT_SUBSCRIPTION_SUBSCRIPTION_DETAIL1`
    ...
    REFERENCES `PRODUCTDB`.`SUBSCRIPTION_DETAIL` (`SUBSCRIPTION_ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PRODUCTDB`.`DESCRIPTION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PRODUCTDB`.`DESCRIPTION` ;

CREATE  TABLE IF NOT EXISTS `PRODUCTDB`.`DESCRIPTION` (
  `DESCRIPTION_CODE` DECIMAL(18) NULL ,
  `DESCRIPTION_VALUE` VARCHAR(512) NULL ,
  `LANGUAGE_CODE` DECIMAL(4) NULL ,
  `MODIFY_DATE` DATETIME NULL ,
  `CHANGE_WHO` VARCHAR(45) NULL ,
  `CREATE_DATE` DATETIME NULL ,
  PRIMARY KEY (`DESCRIPTION_CODE`) ,
  CONSTRAINT `fk_DESCRIPTION_SUBSCRIPTION_DETAIL1`
    FOREIGN KEY (`DESCRIPTION_CODE` )
    REFERENCES `PRODUCTDB`.`SUBSCRIPTION_DETAIL` (`DESCRIPTION_CODE` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
